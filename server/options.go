...
type Options struct {
	...
	EnableForwardAuth   bool             `hcl:"enable_forward_auth" default:"false"`
	Credential          string           `hcl:"credential" flagName:"credential" flagSName:"c" flagDescribe:"Credential for Basic Authentication (ex: user:pass, default disabled)" default:""`
	ForwardAuthServer   string           `hcl:"fwdauth" flagName:"fwdauth" flagSName:"f" flagDescribe:"Forward Auth url" default:""`
